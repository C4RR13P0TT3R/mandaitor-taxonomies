...
//
// Resource patterns follow the standard construction project hierarchy:
// project → zone → trade → document
//
// Pattern syntax: construction:project:{projectId}/zone:{zoneId}/trade:{tradeId}/*
// Wildcard (*) at any level grants access to all sub-resources.
//
// The namespace names the domain, not a vendor, so the same patterns apply
// whatever project platform a tenant runs.
...
export const CONSTRUCTION_RESOURCES: TaxonomyResourcePattern[] = [
  {
    ...
    pattern: "construction:project:{projectId}/zone:{zoneId}/trade:{tradeId}/*",
    description:
  ...
  {
    name: "project-zone",
    pattern: "construction:project:{projectId}/zone:{zoneId}/*",
  ...
  {
    name: "project-wide",
    pattern: "construction:project:{projectId}/*",
    description:
  ...
  },
  {
    ...
    pattern: "construction:project:{projectId}/schedule:{scheduleId}",
  ...
  },
  {
    ...
    pattern: "construction:project:{projectId}/procurement:{orderId}",
  ...
  },
  {
    ...
    pattern: "construction:project:{projectId}/invoice:{invoiceId}",
  ...
  {
    name: "project-defect",
    pattern: "construction:project:{projectId}/defect:{defectId}",
